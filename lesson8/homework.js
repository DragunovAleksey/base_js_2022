...
// var elem = {value: "index.jsПривет"}
// function func(surname, name) {
// console.log(this.value + ', ' + surname + ' ' + name);
// }
// let myFunc = func.bind(elem)
// //Тут напишите конструкцию с bind()

// myFunc('Иванов', 'Иван'); //тут должно вывести 'привет, Иванов Иван'
// myFunc('Петров', 'Петр'); //тут должно вывести 'привет, Петров Петр'
